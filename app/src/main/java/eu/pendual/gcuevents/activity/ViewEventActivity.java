...
public class ViewEventActivity extends Activity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        byDateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(ViewEventActivity.this, ViewEventActivity.this, startYear, startMonth, startDay);
    ...
    private class getAllEvents extends AsyncTask {
        ...
        ProgressDialog progDailog = new ProgressDialog(ViewEventActivity.this);
        @Override
        ...
        protected Object doInBackground(Object[] objects) {
            ...
            StringRequest strReq = new StringRequest(Request.Method.POST,
                    AppConfig.URL_GETALLEVENTS, new Response.Listener<String>() {
    ...
    private class getEventsByDate extends AsyncTask {
        ...
        protected Object doInBackground(Object[] objects) {
            ...
            StringRequest strReq = new StringRequest(Request.Method.POST,
                    AppConfig.URL_SEARCHDATE, new Response.Listener<String>() {
    ...
    private class getEventsByTitle extends AsyncTask {
        ...
        protected Object doInBackground(Object[] objects) {
            ...
            StringRequest strReq = new StringRequest(Request.Method.POST,
                    AppConfig.URL_SEARCHTITLE, new Response.Listener<String>() {
